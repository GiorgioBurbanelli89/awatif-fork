import { A as v, v as _, D as m, c as y } from "./styles-CmYpyXmR.js";
/**
* @license
...
const d = /* @__PURE__ */ new WeakMap(), N = w(class extends M {
  ...
  update(t, [e]) {
    var _a;
    const s = e !== this.G;
    return s && this.G !== void 0 && this.rt(void 0), (s || this.lt !== this.ct) && (this.G = e, this.ht = (_a = t.options) == null ? void 0 : _a.host, this.rt(this.ct = t.element)), v;
  }
  rt(t) {
