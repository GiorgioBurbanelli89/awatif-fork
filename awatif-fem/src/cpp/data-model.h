...
struct NodeInputs
{
    ...
    std::map<int, std::vector<double>> springs; // Map<node_index, [Kx, Ky, Kz, Krx, Kry, Krz]> in N/m or N*m/rad
};
...
// Utils - Template function for map lookup with default value
template <typename K, typename V>
inline V getMapValueOrDefault(const std::map<K, V> &map, const K &key, const V &defaultValue)
{
