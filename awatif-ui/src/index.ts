...
export { getModalAnimation } from "./modal-animation/getModalAnimation";
export type { ModalAnimationOptions, ModalAnimationResult } from "./modal-animation/getModalAnimation";
