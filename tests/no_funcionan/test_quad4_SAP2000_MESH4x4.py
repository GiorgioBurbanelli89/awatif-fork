# -*- coding: utf-8 -*-
"""
Test Quad4 Shell - SAP2000 - MESH 4x4
=====================================

Placa simplemente apoyada con mesh 4x4 = 16 elementos.
...
print("="*70)
print("TEST QUAD4 SHELL - SAP2000 (MESH 4x4)")
print("="*70)
...
try:
    ...
    for i in range(1, elem_id):
        ret = SapModel.AreaObj.SetLoadUniform(f"A{i}", 'CARGA', q, 6, True, "Global", 0)
    ...
    # GUARDAR Y ANALIZAR
    # ========================================
    ModelPath = os.path.join(OUTPUT_DIR, 'test_quad4_mesh4x4_sap2000.sdb')
    ...
    [NumberResults, Obj, Elm, PointElm, LoadCase, StepType, StepNum,
     ...
     V13, V23, VMax, VAngle, ret] = \
        SapModel.Results.AreaForceShell("All", ObjectElm, NumberResults, Obj, Elm,
    ...
    json_path = os.path.join(OUTPUT_DIR, 'sap2000_quad4_mesh4x4_results.json')
